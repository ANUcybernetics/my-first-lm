...
// Joker mode section in two columns
#columns(2, gutter: 1em)[
  == Joker mode
  ...
  + generate text from this random grid using dice as normal
  + train a generation 2 model on the output from your random grid

...
// Title and subtitle
#module-title([Sampling Strategies], subtitle: "My First LM Module #6")

// First page content with image on right
#first-page-with-image("images/CYBERNETICS_A_098.jpg")[
...
#column-section[
  ...
  Note: any of the truncation strategies can be combined with temperature
  control.
